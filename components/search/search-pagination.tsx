...
export function SearchPagination({ currentPage, totalPages, total, limit, onPageChange }: SearchPaginationProps) {
      ...
      <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700 dark:text-gray-300">
            ...
            <span className="font-medium">{endResult}</span> of <span className="font-medium">{total}</span> results
          </p>
        </div>
